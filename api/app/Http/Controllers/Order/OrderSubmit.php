...
{
    public function generateUniqueRandomNumber($length = 5)
    {
        do {
    ...
    public function submitOrder(Request $request)
    {
        ...
        $validator = FacadesValidator::make(
            ...
            [
                ...
                'Cutomer_name.required' => 'Please add your customer number',
        ...
        $customer_email = ! empty($request->Cutomer_email) ? $request->Cutomer_email : $request->Cutomer_phone_number.'_'.uniqid().'@gmail.com';

        $user = User::where('email', $customer_email)
        ...
        if (! $user) {
            ...
            $this->sms_send_login_details($request->Cutomer_phone_number, $customer_email, $password);
        }
        $userId = $user->id;
        // echo $userId;exit;
        // $this->userid = $user->id;
