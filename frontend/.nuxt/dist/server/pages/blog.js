exports.ids = [60,17,18,19,21,23,25,28,29,33,36,42];
exports.modules = {
...
module.exports.__inject__ = function (context) {
  add("41e0eed8", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_blog_vue_vue_type_style_index_0_id_bdc56ed6_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(102);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_blog_vue_vue_type_style_index_0_id_bdc56ed6_prod_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_blog_vue_vue_type_style_index_0_id_bdc56ed6_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_blog_vue_vue_type_style_index_0_id_bdc56ed6_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_blog_vue_vue_type_style_index_0_id_bdc56ed6_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".blog_sidebar.active{background:#fff;display:block!important;left:0;min-height:100vh;min-width:260px;position:fixed;top:62px}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog.vue?vue&type=template&id=bdc56ed6
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('LogoAndPayment'), _vm._ssrNode(" "), _c('NavbarSecond'), _vm._ssrNode(" <section class=\"main_content mt-3\"><div class=\"container\"><div class=\"row\"><div class=\"col-3\"><div class=\"blog_sidebar d-md-block d-none\"><div class=\"d-flex justify-content-between align-items-center\"><h6>Categories</h6> <button class=\"bt_close d-md-none d-block text-dark\"><i class=\"fa-solid fa-x\"></i></button></div> <form action><hr> " + _vm._ssrList(_vm.blogCat, function (category) {
    return "<div class=\"form_align\"><input type=\"checkbox\"" + _vm._ssrAttr("id", category.id) + _vm._ssrAttr("name", category.id) + _vm._ssrAttr("value", category.name) + _vm._ssrAttr("checked", Array.isArray(_vm.selectedCategories) ? _vm._i(_vm.selectedCategories, category.name) > -1 : _vm.selectedCategories) + "> <label" + _vm._ssrAttr("for", category.id) + ">" + _vm._ssrEscape(_vm._s(category.name)) + "</label></div>";
  }) + "</form></div></div> <div class=\"col-md-9\"><div class=\"row\"><div class=\"col-md-12\"><div class=\"page_title d-flex justify-content-between align-items-center d-md-none\"><h4>Blogs</h4> <button type=\"button\" class=\"btn_edit btn_sidebar\"><i class=\"fa-solid\"><i class=\"fa-solid fa-filter\"></i></i></button></div></div></div> <div class=\"bologContainer\">" + _vm._ssrList(_vm.blogs, function (blog) {
    return "<div class=\"blog_box\"><img" + _vm._ssrAttr("src", blog.image) + " alt class=\"img-fluid\"> <div class=\"d-flex justify-content-between align-items-center\"><span>" + _vm._ssrEscape(_vm._s(blog.created_at)) + "</span> <strong>" + _vm._ssrEscape(_vm._s(blog.category_name)) + "</strong></div> <a>" + _vm._ssrEscape(_vm._s(blog.title)) + "</a> <p>" + _vm._s(blog.content) + "</p> <a class=\"blogLink\">Read Full Blog <i class=\"fa-solid fa-arrow-right\"></i></a></div>";
  }) + "</div></div></div></div></section> <div class=\"back_top\"><a href=\"#top\"><i class=\"fa-solid fa-angle-up\"></i></a></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/blog.vue?vue&type=template&id=bdc56ed6
...
// EXTERNAL MODULE: ./components/FlashSaleFilter.vue + 2 modules
var FlashSaleFilter = __webpack_require__(76);
...
/* harmony default export */ var blogvue_type_script_lang_js = ({
  components: {
    ...
    FlashSaleFilter: FlashSaleFilter["default"],
  ...
  methods: {
    ...
    jqueryScripts() {
      external_jquery_default()(".btn_sidebar").click(() => {
        external_jquery_default()(".blog_sidebar").addClass('active');
      });
      external_jquery_default()(".bt_close").click(() => {
        external_jquery_default()(".blog_sidebar").removeClass('active');
      });
    },
    getBlogs() {
      this.$axios.get("/unauthenticate/blogs").then(response => {
    ...
    getBlogCat() {
      this.$axios.get("/unauthenticate/blogCat").then(response => {
        // console.log(response.data);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/FlashSaleFilter.vue?vue&type=template&id=144469cc
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-12\">", "</div>", [_vm._ssrNode("<div class=\"product_section\">", "</div>", [_vm._ssrNode("<div class=\"row px-2\">", "</div>", [_vm._ssrNode("<div class=\"col-md-4 desktop_view\"><div class=\"left_side_product\"><div class=\"category_list\"><h6>Category</h6> <ul><li><a href=\"#\">Computing</a></li> <li><a href=\"#\">Electronics</a></li> <li><a href=\"#\">Phone &amp; tablates</a></li> <li><a href=\"#\">Fashion</a></li> <li><a href=\"#\">Home &amp; office </a></li> <li><a href=\"#\">Grocery</a></li> <li><a href=\"#\">Health &amp; beauty</a></li> <li><a href=\"#\">Baby Product</a></li></ul></div> <div class=\"delivery_list\"><h6>Express delivery</h6> <ul><li><input type=\"checkbox\"><label for>DHL </label></li></ul></div> <div class=\"delivery_list\"><h6>Shipped from </h6> <ul><li><input type=\"checkbox\"><label for>From Bangladesh </label></li> <li><input type=\"checkbox\"><label for>From Bangladesh </label></li></ul></div> <div class=\"brands_list\"><h6>Brand</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li></ul></div> <div class=\"price_range\"><div class=\"sidebr_title\"><h6>Price Range </h6> <button type=\"button\" class=\"btn_apply\">Apply</button></div> <div class=\"row\"><div class=\"col-md-12\"><div id=\"slider-range\" name=\"rangeInput\" class=\"price-filter-range\"></div> <div class=\"d-flex\" style=\"margin:10px auto\"><input type=\"number\" min=\"0\" max=\"9900\" oninput=\"validity.valid||(value='0');\" id=\"min_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px;\"> <input type=\"number\" min=\"0\" max=\"10000\" oninput=\"validity.valid||(value='10000');\" id=\"max_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px\"></div></div></div></div> <div class=\"brands_list\"><h6>size</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>XS</label></li> <li><input type=\"checkbox\"><label for>S</label></li> <li><input type=\"checkbox\"><label for>L</label></li> <li><input type=\"checkbox\"><label for>M </label></li> <li><input type=\"checkbox\"><label for>XL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>0-2 Years</label></li> <li><input type=\"checkbox\"><label for>2-3 Years</label></li> <li><input type=\"checkbox\"><label for>3-5 Years</label></li> <li><input type=\"checkbox\"><label for>5-7 Years</label></li> <li><input type=\"checkbox\"><label for>7-10 Years</label></li></ul></div> <div class=\"brands_list\"><h6>Gender</h6> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Boys</label></li> <li><input type=\"checkbox\"><label for>Girls</label></li> <li><input type=\"checkbox\"><label for>Man</label></li> <li><input type=\"checkbox\"><label for>Woman</label></li> <li><input type=\"checkbox\"><label for>Male</label></li> <li><input type=\"checkbox\"><label for>Female</label></li> <li><input type=\"checkbox\"><label for>Teen</label></li></ul></div></div></div> "), _vm._ssrNode("<div class=\"col-md-8\">", "</div>", [_vm._ssrNode("<div class=\"product_list p-0\">", "</div>", [_vm._ssrNode("<div class=\"title_product bg_flashSell top_title_here\"><div><h6>Officail Store Deals</h6></div> <div><label for>Short By:</label> <select name id style=\"color: #fff;\"><option value>Popularity</option> <option value>New arrival</option> <option value>Low to High</option> <option value>high to low</option></select></div></div> <div class=\"grid_list p-3\"><div><p>5,000 product found</p></div> <div class=\"d-flex\"><a type=\"button\" class=\"filter_btn mobile_view\"><i class=\"fa-solid fa-sliders\"></i></a> <a href=\"flashsell-list.html\" class=\"active\"><i class=\"fa-solid fa-list\"></i></a> <a href=\"flashsell-grid.html\"><i class=\"fa-solid fa-grip\"></i></a></div> <div class=\"filter_modal\"><div class=\"row px-4\"><div class=\"col-6\"></div> <div class=\"col-6 text-end\"><i class=\"fa-solid fa-x filter_close\" style=\"cursor: pointer;\"></i></div></div> <div class=\"modal_fdiv\"><div class=\"row\"><div class=\"col-md-12\"><div class=\"left_side_product\"><div class=\"category_list\"><h6>Category</h6> <ul><li><a href=\"#\">Computing</a></li> <li><a href=\"#\">Electronics</a></li> <li><a href=\"#\">Phone &amp; tablates</a></li> <li><a href=\"#\">Fashion</a></li> <li><a href=\"#\">Home &amp; office </a></li> <li><a href=\"#\">Grocery</a></li> <li><a href=\"#\">Health &amp; beauty</a></li> <li><a href=\"#\">Baby Product</a></li></ul></div> <div class=\"delivery_list\"><h6>Express delivery</h6> <ul><li><input type=\"checkbox\"><label for>DHL </label></li></ul></div> <div class=\"delivery_list\"><h6>Shipped from </h6> <ul><li><input type=\"checkbox\"><label for>From Bangladesh </label></li> <li><input type=\"checkbox\"><label for>From Bangladesh </label></li></ul></div> <div class=\"brands_list\"><h6>Brand</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li></ul></div> <div class=\"price_range\"><div class=\"sidebr_title\"><h6>Price Range </h6> <button type=\"button\" class=\"btn_apply\">Apply</button></div> <div class=\"row\"><div class=\"col-md-12\"><div id=\"slider-range\" name=\"rangeInput\" class=\"price-filter-range\"></div> <div class=\"d-flex\" style=\"margin:10px auto\"><input type=\"number\" min=\"0\" max=\"9900\" oninput=\"validity.valid||(value='0');\" id=\"min_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px;\"> <input type=\"number\" min=\"0\" max=\"10000\" oninput=\"validity.valid||(value='10000');\" id=\"max_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px\"></div></div></div></div> <div class=\"brands_list\"><h6>size</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>XS</label></li> <li><input type=\"checkbox\"><label for>S</label></li> <li><input type=\"checkbox\"><label for>L</label></li> <li><input type=\"checkbox\"><label for>M </label></li> <li><input type=\"checkbox\"><label for>XL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>0-2 Years</label></li> <li><input type=\"checkbox\"><label for>2-3 Years</label></li> <li><input type=\"checkbox\"><label for>3-5 Years</label></li> <li><input type=\"checkbox\"><label for>5-7 Years</label></li> <li><input type=\"checkbox\"><label for>7-10 Years</label></li></ul></div> <div class=\"brands_list\"><h6>Gender</h6> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Boys</label></li> <li><input type=\"checkbox\"><label for>Girls</label></li> <li><input type=\"checkbox\"><label for>Man</label></li> <li><input type=\"checkbox\"><label for>Woman</label></li> <li><input type=\"checkbox\"><label for>Male</label></li> <li><input type=\"checkbox\"><label for>Female</label></li> <li><input type=\"checkbox\"><label for>Teen</label></li></ul></div></div></div></div></div></div></div> "), _vm._ssrNode("<div class=\"row p-3\">", "</div>", [_vm._ssrNode("<div class=\"col-12\">", "</div>", [_c('Nuxt-link', {
    attrs: {
      "to": "/product-details"
    }
  }, [_c('div', {
  ...
  }, [_c('strike', [_vm._v("Tk 6,500")]), _c('span', [_vm._v("-45%")])], 1), _vm._v(" "), _c('p', {
...
// CONCATENATED MODULE: ./components/FlashSaleFilter.vue?vue&type=template&id=144469cc

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/FlashSaleFilter.vue
...
/* harmony default export */ var FlashSaleFilter = __webpack_exports__["default"] = (component.exports);
