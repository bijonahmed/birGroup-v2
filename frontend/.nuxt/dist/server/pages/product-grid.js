exports.ids = [86,7,10,17,18,19,21,22,25,28,29,33,36,40,41,42];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/ProductListFilterGrid.vue?vue&type=template&id=33987a72
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-12\">", "</div>", [_vm._ssrNode("<div class=\"product_section\">", "</div>", [_vm._ssrNode("<div class=\"row px-2\">", "</div>", [_vm._ssrNode("<div class=\"col-md-4 desktop_view\"><div class=\"left_side_product\"><div class=\"category_list\"><h6>Category</h6> <ul><li><a href=\"#\">Computing</a></li> <li><a href=\"#\">Electronics</a></li> <li><a href=\"#\">Phone &amp; tablates</a></li> <li><a href=\"#\">Fashion</a></li> <li><a href=\"#\">Home &amp; office </a></li> <li><a href=\"#\">Grocery</a></li> <li><a href=\"#\">Health &amp; beauty</a></li> <li><a href=\"#\">Baby Product</a></li></ul></div> <div class=\"delivery_list\"><h6>Express delivery</h6> <ul><li><input type=\"checkbox\"><label for>DHL </label></li></ul></div> <div class=\"delivery_list\"><h6>Shipped from </h6> <ul><li><input type=\"radio\" checked=\"checked\" name=\"from\" id=\"from\"><label for=\"from\">From Bangladesh </label></li> <li><input type=\"radio\" name=\"from\" id=\"from\"><label for=\"from\">From Bangladesh </label></li></ul></div> <div class=\"brands_list\"><h6>Brand</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li></ul></div> <div class=\"price_range\"><div class=\"sidebr_title\"><h6>Price Range </h6> <button type=\"button\" class=\"btn_apply\">Apply</button></div> <div class=\"row\"><div class=\"col-md-12\"><div id=\"slider-range\" name=\"rangeInput\" class=\"price-filter-range\"></div> <div class=\"d-flex\" style=\"margin:10px auto\"><input type=\"number\" min=\"0\" max=\"9900\" oninput=\"validity.valid||(value='0');\" id=\"min_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px;\"> <input type=\"number\" min=\"0\" max=\"10000\" oninput=\"validity.valid||(value='10000');\" id=\"max_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px\"></div></div></div></div> <div class=\"brands_list\"><h6>size</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>XS</label></li> <li><input type=\"checkbox\"><label for>S</label></li> <li><input type=\"checkbox\"><label for>L</label></li> <li><input type=\"checkbox\"><label for>M </label></li> <li><input type=\"checkbox\"><label for>XL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>0-2 Years</label></li> <li><input type=\"checkbox\"><label for>2-3 Years</label></li> <li><input type=\"checkbox\"><label for>3-5 Years</label></li> <li><input type=\"checkbox\"><label for>5-7 Years</label></li> <li><input type=\"checkbox\"><label for>7-10 Years</label></li></ul></div> <div class=\"brands_list\"><h6>Gender</h6> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Boys</label></li> <li><input type=\"checkbox\"><label for>Girls</label></li> <li><input type=\"checkbox\"><label for>Man</label></li> <li><input type=\"checkbox\"><label for>Woman</label></li> <li><input type=\"checkbox\"><label for>Male</label></li> <li><input type=\"checkbox\"><label for>Female</label></li> <li><input type=\"checkbox\"><label for>Teen</label></li></ul></div></div></div> "), _vm._ssrNode("<div class=\"col-md-8\">", "</div>", [_vm._ssrNode("<div class=\"product_list\">", "</div>", [_vm._ssrNode("<div class=\"title_product\"><div><h6>Officail Store Deals</h6></div> <div><label for>Short By:</label> <select name id><option value>Popularity</option> <option value>New arrival</option> <option value>Low to High</option> <option value>high to low</option></select></div></div> "), _vm._ssrNode("<div class=\"grid_list\">", "</div>", [_vm._ssrNode("<div><p>5,000 product found</p></div> "), _vm._ssrNode("<div class=\"d-flex\">", "</div>", [_vm._ssrNode("<a type=\"button\" class=\"filter_btn mobile_view\"><i class=\"fa-solid fa-sliders\"></i></a> "), _c('Nuxt-Link', {
    attrs: {
      "to": "/product-list"
    }
  }, [_c('i', {
  ...
  })])], 2), _vm._ssrNode(" <div class=\"filter_modal\"><div class=\"row px-4\"><div class=\"col-6\"></div> <div class=\"col-6 text-end\"><i class=\"fa-solid fa-x filter_close\" style=\"cursor: pointer;\"></i></div></div> <div class=\"modal_fdiv\"><div class=\"row\"><div class=\"col-md-12\"><div class=\"left_side_product\"><div class=\"category_list\"><h6>Category</h6> <ul><li><a href=\"#\">Computing</a></li> <li><a href=\"#\">Electronics</a></li> <li><a href=\"#\">Phone &amp; tablates</a></li> <li><a href=\"#\">Fashion</a></li> <li><a href=\"#\">Home &amp; office </a></li> <li><a href=\"#\">Grocery</a></li> <li><a href=\"#\">Health &amp; beauty</a></li> <li><a href=\"#\">Baby Product</a></li></ul></div> <div class=\"delivery_list\"><h6>Express delivery</h6> <ul><li><input type=\"checkbox\"><label for>DHL </label></li></ul></div> <div class=\"delivery_list\"><h6>Shipped from </h6> <ul><li><input type=\"checkbox\"><label for>From Bangladesh </label></li> <li><input type=\"checkbox\"><label for>From Bangladesh </label></li></ul></div> <div class=\"brands_list\"><h6>Brand</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li></ul></div> <div class=\"price_range\"><div class=\"sidebr_title\"><h6>Price Range </h6> <button type=\"button\" class=\"btn_apply\">Apply</button></div> <div class=\"row\"><div class=\"col-md-12\"><div id=\"slider-range\" name=\"rangeInput\" class=\"price-filter-range\"></div> <div class=\"d-flex\" style=\"margin:10px auto\"><input type=\"number\" min=\"0\" max=\"9900\" oninput=\"validity.valid||(value='0');\" id=\"min_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px;\"> <input type=\"number\" min=\"0\" max=\"10000\" oninput=\"validity.valid||(value='10000');\" id=\"max_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px\"></div></div></div></div> <div class=\"brands_list\"><h6>size</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>XS</label></li> <li><input type=\"checkbox\"><label for>S</label></li> <li><input type=\"checkbox\"><label for>L</label></li> <li><input type=\"checkbox\"><label for>M </label></li> <li><input type=\"checkbox\"><label for>XL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>0-2 Years</label></li> <li><input type=\"checkbox\"><label for>2-3 Years</label></li> <li><input type=\"checkbox\"><label for>3-5 Years</label></li> <li><input type=\"checkbox\"><label for>5-7 Years</label></li> <li><input type=\"checkbox\"><label for>7-10 Years</label></li></ul></div> <div class=\"brands_list\"><h6>Gender</h6> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Boys</label></li> <li><input type=\"checkbox\"><label for>Girls</label></li> <li><input type=\"checkbox\"><label for>Man</label></li> <li><input type=\"checkbox\"><label for>Woman</label></li> <li><input type=\"checkbox\"><label for>Male</label></li> <li><input type=\"checkbox\"><label for>Female</label></li> <li><input type=\"checkbox\"><label for>Teen</label></li></ul></div></div></div></div></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(1).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(2).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(3).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(4).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(5).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(6).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(7).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(8).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6\">", "</div>", [_vm._ssrNode("<a href=\"product-details.html\">", "</a>", [_vm._ssrNode("<div class=\"product_grid\">", "</div>", [_vm._ssrNode("<img src=\"images/product(9).jpg\" alt class=\"img-fluid\"> <span>Free Delivery</span> <strong>Official Store </strong> <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus, totam!</h1> <p>TK 6,500</p> "), _vm._ssrNode("<p>", "</p>", [_c('strike', [_vm._v("TK 6,500")]), _vm._ssrNode(" <span>-5%</span>")], 2), _vm._ssrNode(" <div class=\"d-flex align-items-center\"><div class=\"rating\"><i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star checked\"></i> <i class=\"fa fa-star\"></i></div> <h6>(200)</h6></div> <button type=\"button\" class=\"btn_cart\">Add to cart </button>")], 2)])])], 2), _vm._ssrNode(" <div class=\"row\"><div class=\"col-12\"><div class=\"pagination\"><ul><li><a href=\"#\"> prv </a></li> <li><a href=\"#\" class=\"active\"> 1 </a></li> <li><a href=\"#\"> 2 </a></li> <li><a href=\"#\"> 3 </a></li> <li><a href=\"#\"> next </a></li></ul></div></div></div>")], 2)])], 2)])])])]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/ProductListFilterGrid.vue?vue&type=template&id=33987a72

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/ProductListFilterGrid.vue
...
/* harmony default export */ var ProductListFilterGrid = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/product-grid.vue?vue&type=template&id=371c7e1f
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('LogoAndPayment'), _vm._ssrNode(" "), _c('NavbarSecond'), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"main_content\">", "</section>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_c('OfficialStoreProductList'), _vm._ssrNode(" "), _c('ProductListFilterGrid'), _vm._ssrNode(" "), _c('RecentView')], 2)]), _vm._ssrNode(" <div class=\"back_top\"><a href=\"#top\"><i class=\"fa-solid fa-angle-up\"></i></a></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/product-grid.vue?vue&type=template&id=371c7e1f
...
var CategoryProductFilter = __webpack_require__(79);

// EXTERNAL MODULE: ./components/ExtraDiscount.vue + 2 modules
var ExtraDiscount = __webpack_require__(80);

// EXTERNAL MODULE: ./components/CategoryMultipleProduct.vue + 2 modules
var CategoryMultipleProduct = __webpack_require__(81);

// EXTERNAL MODULE: ./components/RecentView.vue + 2 modules
var RecentView = __webpack_require__(69);

// EXTERNAL MODULE: ./components/OfficialStoreProductList.vue + 2 modules
var OfficialStoreProductList = __webpack_require__(74);

// EXTERNAL MODULE: ./components/ProductListFilterList.vue + 2 modules
var ProductListFilterList = __webpack_require__(82);

// EXTERNAL MODULE: ./components/NavbarSecond.vue + 4 modules
var NavbarSecond = __webpack_require__(60);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/product-grid.vue?vue&type=script&lang=js
...
/* harmony default export */ var product_gridvue_type_script_lang_js = ({
  components: {
    ...
    OfficialStoreProductList: OfficialStoreProductList["default"],
    ProductListFilterList: ProductListFilterList["default"]
  },
  head: {
    title: 'Product Grid'
  },
...
// CONCATENATED MODULE: ./pages/product-grid.vue?vue&type=script&lang=js
 /* harmony default export */ var pages_product_gridvue_type_script_lang_js = (product_gridvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/product-grid.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_product_gridvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var product_grid = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {LogoAndPayment: __webpack_require__(66).default,NavbarSecond: __webpack_require__(60).default,OfficialStoreProductList: __webpack_require__(74).default,ProductListFilterGrid: __webpack_require__(158).default,RecentView: __webpack_require__(69).default,Footer: __webpack_require__(57).default})
...
module.exports.__inject__ = function (context) {
  add("f6296922", content, true, context)
};
...
var LoginPopup = __webpack_require__(61);
...
/* harmony default export */ var DesktopViewOptionvue_type_script_lang_js = ({
  components: {
...
// CONCATENATED MODULE: ./components/DesktopViewOption.vue?vue&type=script&lang=js
 /* harmony default export */ var components_DesktopViewOptionvue_type_script_lang_js = (DesktopViewOptionvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);
...
var component = Object(componentNormalizer["a" /* default */])(
  components_DesktopViewOptionvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Footer.vue?vue&type=template&id=2390f6ca
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
// CONCATENATED MODULE: ./components/Footer.vue?vue&type=template&id=2390f6ca
...
/* harmony default export */ var Common_MobileSidebarvue_type_script_lang_js = ({
  data() {
    return {
      limit: 12,
      categories: []
...
// CONCATENATED MODULE: ./components/Common_MobileSidebar.vue?vue&type=script&lang=js
 /* harmony default export */ var components_Common_MobileSidebarvue_type_script_lang_js = (Common_MobileSidebarvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);
...
var component = Object(componentNormalizer["a" /* default */])(
  components_Common_MobileSidebarvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var Common_MiniTabNavbarvue_type_script_lang_js = ({
  data() {
    return {
      limit: 12,
      categories: []
...
// CONCATENATED MODULE: ./components/Common_MiniTabNavbar.vue?vue&type=script&lang=js
 /* harmony default export */ var components_Common_MiniTabNavbarvue_type_script_lang_js = (Common_MiniTabNavbarvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);
...
var component = Object(componentNormalizer["a" /* default */])(
  components_Common_MiniTabNavbarvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
var DesktopViewOption = __webpack_require__(56);
...
/* harmony default export */ var NavbarSecondvue_type_script_lang_js = ({
  components: {
    Common_MobileSidebar: Common_MobileSidebar["default"],
    Common_MiniTabNavbar: Common_MiniTabNavbar["default"],
...
// CONCATENATED MODULE: ./components/NavbarSecond.vue?vue&type=script&lang=js
 /* harmony default export */ var components_NavbarSecondvue_type_script_lang_js = (NavbarSecondvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);
...
var component = Object(componentNormalizer["a" /* default */])(
  components_NavbarSecondvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* nuxt-component-imports */
installComponents(component, {DesktopViewOption: __webpack_require__(56).default})
...
/* harmony default export */ var LoginPopupvue_type_script_lang_js = ({
  data() {
    return {
      loading: false,
      login: {
...
// CONCATENATED MODULE: ./components/LoginPopup.vue?vue&type=script&lang=js
 /* harmony default export */ var components_LoginPopupvue_type_script_lang_js = (LoginPopupvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);
...
var component = Object(componentNormalizer["a" /* default */])(
  components_LoginPopupvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DesktopViewOption_vue_vue_type_style_index_0_id_033a27c1_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(54);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DesktopViewOption_vue_vue_type_style_index_0_id_033a27c1_prod_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DesktopViewOption_vue_vue_type_style_index_0_id_033a27c1_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DesktopViewOption_vue_vue_type_style_index_0_id_033a27c1_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DesktopViewOption_vue_vue_type_style_index_0_id_033a27c1_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/OfficialStoreProductList.vue?vue&type=template&id=7fe287ea
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"row mt-2\">", "</div>", [_vm._ssrNode("<div class=\"col-12\">", "</div>", [_vm._ssrNode("<div class=\"category\">", "</div>", [_vm._ssrNode("<div class=\"row\"><div class=\"sell_title bg_appliance justify-content-center\"><div class=\"text-center\"><h5>Offical Store</h5></div></div></div> "), _vm._ssrNode("<div class=\"row px-2\">", "</div>", [_vm._ssrNode("<div class=\"col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4\">", "</div>", [_c('Nuxt-Link', {
    attrs: {
      "to": "/product-list"
    }
  }, [_c('div', {
  ...
  })])])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4\">", "</div>", [_c('Nuxt-Link', {
    attrs: {
      "to": "/product-list"
    }
  }, [_c('div', {
    ...
    staticClass: "img-fluid",
    attrs: {
      "src": "/images/brands/tecno_260x144.png",
      "alt": ""
    }
  })])])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4\">", "</div>", [_c('Nuxt-Link', {
    attrs: {
    ...
    staticClass: "img-fluid",
    attrs: {
      "src": "/images/brands/xiaomi_260x144.png",
      "alt": ""
    }
  })])])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4\">", "</div>", [_c('Nuxt-Link', {
    attrs: {
    ...
    staticClass: "img-fluid",
    attrs: {
      "src": "/images/brands/260x144-Nestle.png",
      "alt": ""
    }
  })])])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4\">", "</div>", [_c('Nuxt-Link', {
    attrs: {
    ...
    staticClass: "img-fluid",
    attrs: {
      "src": "/images/brands/adidas_260x144_V2.png",
      "alt": ""
    }
  })])])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4\">", "</div>", [_c('Nuxt-Link', {
    attrs: {
...
// CONCATENATED MODULE: ./components/OfficialStoreProductList.vue?vue&type=template&id=7fe287ea

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/OfficialStoreProductList.vue
...
/* harmony default export */ var OfficialStoreProductList = __webpack_exports__["default"] = (component.exports);
...
var add = __webpack_require__(9).default
module.exports.__inject__ = function (context) {
  add("4be39aba", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CategoryProductFilter_vue_vue_type_style_index_0_id_563a0445_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CategoryProductFilter_vue_vue_type_style_index_0_id_563a0445_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CategoryProductFilter_vue_vue_type_style_index_0_id_563a0445_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CategoryProductFilter_vue_vue_type_style_index_0_id_563a0445_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CategoryProductFilter_vue_vue_type_style_index_0_id_563a0445_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".loading-indicator[data-v-563a0445]{background-color:hsla(0,0%,100%,.8);height:100%;left:0;position:fixed;top:0;width:100%;z-index:9999}.loader-container[data-v-563a0445],.loading-indicator[data-v-563a0445]{align-items:center;display:flex;justify-content:center}.loader-container[data-v-563a0445]{flex-direction:column;height:100vh;position:relative}.loader-text[data-v-563a0445]{margin:0}.loader-top[data-v-563a0445]{top:0}.loader-bottom[data-v-563a0445]{bottom:0}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/CategoryProductFilter.vue?vue&type=template&id=563a0445&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"row\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div class=\"col-12\" data-v-563a0445>", "</div>", [_vm.loading ? _vm._ssrNode("<div class=\"loading-indicator\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div class=\"loader-container\" data-v-563a0445>", "</div>", [_c('center', {
    staticClass: "loader-text"
  }, [_vm._v("Loading...")]), _vm._ssrNode(" <img src=\"/loader/loader.gif\" alt=\"Loader\" data-v-563a0445>")], 2)]) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"product_section\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div class=\"row px-2\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div class=\"col-md-4 desktop_view\" data-v-563a0445><div class=\"left_side_product\" data-v-563a0445><div class=\"category_list\" data-v-563a0445><h6 data-v-563a0445>Category</h6> <ul data-v-563a0445>" + _vm._ssrList(_vm.categories, function (category) {
    return "<li data-v-563a0445><a href=\"#\" data-v-563a0445>" + _vm._ssrEscape(_vm._s(category.name)) + "</a></li>";
  }) + "</ul></div></div></div> "), _vm._ssrNode("<div class=\"col-md-8\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div class=\"product_list\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div class=\"title_product\" data-v-563a0445><div data-v-563a0445><h6 data-v-563a0445>" + _vm._ssrEscape(_vm._s(_vm.categoryname)) + "</h6></div> <div class=\"d-none\" data-v-563a0445><label for data-v-563a0445>Short By:</label> <select name id data-v-563a0445><option value data-v-563a0445>Popularity</option> <option value data-v-563a0445>New arrival</option> <option value data-v-563a0445>Low to High</option> <option value data-v-563a0445>high to low</option></select></div></div> "), _vm._ssrNode("<div class=\"grid_list\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div data-v-563a0445><p data-v-563a0445>" + _vm._ssrEscape(_vm._s(_vm.pro_count) + " product found") + "</p></div> "), _vm._ssrNode("<div class=\"d-flex\" data-v-563a0445>", "</div>", [_c('Nuxt-Link', {
    staticClass: "active",
    attrs: {
      "to": "/category/category-list"
    }
    ...
    staticClass: "fa-solid fa-list"
  })])], 1), _vm._ssrNode(" <div class=\"filter_modal\" data-v-563a0445><div class=\"row px-4\" data-v-563a0445><div class=\"col-6\" data-v-563a0445></div> <div class=\"col-6 text-end\" data-v-563a0445><i class=\"fa-solid fa-x filter_close\" style=\"cursor: pointer;\" data-v-563a0445></i></div></div> <div class=\"modal_fdiv\" data-v-563a0445><div class=\"row\" data-v-563a0445><div class=\"col-md-12\" data-v-563a0445><div class=\"left_side_product\" data-v-563a0445><div class=\"category_list\" data-v-563a0445><h6 data-v-563a0445>Category</h6> <ul data-v-563a0445><li data-v-563a0445><a href=\"#\" data-v-563a0445>Computing</a></li> <li data-v-563a0445><a href=\"#\" data-v-563a0445>Electronics</a></li></ul></div> <div class=\"delivery_list\" data-v-563a0445><h6 data-v-563a0445>Express delivery</h6> <ul data-v-563a0445><li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>DHL </label></li></ul></div> <div class=\"delivery_list\" data-v-563a0445><h6 data-v-563a0445>Shipped from </h6> <ul data-v-563a0445><li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>From Bangladesh </label></li> <li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>From Bangladesh </label></li></ul></div> <div class=\"brands_list\" data-v-563a0445><h6 data-v-563a0445>Brand</h6> <div class=\"search_side\" data-v-563a0445><i class=\"fa-solid fa-magnifying-glass\" data-v-563a0445></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\" data-v-563a0445></div> <ul class=\"brand_scroll\" data-v-563a0445><li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>Addidas </label></li> <li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>AGM </label></li></ul></div> <div class=\"price_range\" data-v-563a0445><div class=\"sidebr_title\" data-v-563a0445><h6 data-v-563a0445>Price Range </h6> <button type=\"button\" class=\"btn_apply\" data-v-563a0445>Apply</button></div> <div class=\"row\" data-v-563a0445><div class=\"col-md-12\" data-v-563a0445><div id=\"slider-range\" name=\"rangeInput\" class=\"price-filter-range\" data-v-563a0445></div> <div class=\"d-flex\" style=\"margin:10px auto\" data-v-563a0445><input type=\"number\" min=\"0\" max=\"9900\" oninput=\"validity.valid||(value='0');\" id=\"min_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px;\" data-v-563a0445> <input type=\"number\" min=\"0\" max=\"10000\" oninput=\"validity.valid||(value='10000');\" id=\"max_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px\" data-v-563a0445></div></div></div></div> <div class=\"brands_list\" data-v-563a0445><h6 data-v-563a0445>size</h6> <div class=\"search_side\" data-v-563a0445><i class=\"fa-solid fa-magnifying-glass\" data-v-563a0445></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\" data-v-563a0445></div> <ul class=\"brand_scroll\" data-v-563a0445><li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>XS</label></li> <li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>S</label></li></ul></div> <div class=\"brands_list\" data-v-563a0445><h6 data-v-563a0445>Gender</h6> <ul class=\"brand_scroll\" data-v-563a0445><li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>Boys</label></li> <li data-v-563a0445><input type=\"checkbox\" data-v-563a0445><label for data-v-563a0445>Girls</label></li></ul></div></div></div></div></div></div>")], 2), _vm._ssrNode(" <div class=\"d-none\" data-v-563a0445>\r\n                                this div specially for testing\r\n                                <h2 data-v-563a0445>Shopping Cart</h2> <ul data-v-563a0445>" + _vm._ssrList(_vm.cart, function (item) {
    return "<li data-v-563a0445>" + _vm._ssrEscape("\r\n                                        " + _vm._s(item.product.product_name) + " - $" + _vm._s(item.product.price) + " (Qty: " + _vm._s(item.quantity) + ")-\r\n                                        ") + "<input type=\"number\"" + _vm._ssrAttr("value", item.updatedQuantity) + " data-v-563a0445> <button data-v-563a0445>Update Quantity</button> <button data-v-563a0445>Remove</button> <hr data-v-563a0445></li>";
  }) + "</ul> <p data-v-563a0445>" + _vm._ssrEscape("Subtotal: $" + _vm._s(_vm.subtotal) + "\r\n\r\n                                ") + "</p> <p data-v-563a0445>" + _vm._ssrEscape("Items in Cart: " + _vm._s(_vm.itemCount)) + "</p> <hr data-v-563a0445></div> "), _vm._l(_vm.prouducts, function (item) {
    return _vm._ssrNode("<div class=\"row\" data-v-563a0445>", "</div>", [_vm.prouducts.length > 0 ? _vm._ssrNode("<div" + _vm._ssrAttr("id", item.id) + " class=\"col-12\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div class=\"products_list\" data-v-563a0445>", "</div>", [_vm._ssrNode("<div class=\"col\" data-v-563a0445>", "</div>", [_c('nuxt-link', {
      attrs: {
    ...
    }), _vm._v(" "), item.free_shopping == 1 ? _c('span', [_vm._v("Free Delivery ")]) : _vm._e()])], 1), _vm._ssrNode(" <div class=\"col pad_ding\" data-v-563a0445>" + (item.seller_name ? "<strong data-v-563a0445>" + _vm._ssrEscape(_vm._s(item.seller_name)) + "</strong>" : "<strong data-v-563a0445>Admin Seller</strong>") + " <h5 data-v-563a0445>" + _vm._ssrEscape(_vm._s(item.product_name)) + "</h5> <div class=\"d-flex align-items-center\" data-v-563a0445><div class=\"ratings m-0\" data-v-563a0445><i class=\"fa fa-star checked\" data-v-563a0445></i> <i class=\"fa fa-star checked\" data-v-563a0445></i> <i class=\"fa fa-star checked\" data-v-563a0445></i> <i class=\"fa fa-star checked\" data-v-563a0445></i> <i class=\"fa fa-star\" data-v-563a0445></i></div> <h6 class=\"m-0\" data-v-563a0445>(200)</h6></div> <div class=\"short_des\" data-v-563a0445><p class=\"mt-0\" data-v-563a0445>" + _vm._s(item.short_description) + "</p></div></div> "), _vm._ssrNode("<div class=\"col pad_ding\" data-v-563a0445>", "</div>", [item.discount_status == 1 ? _vm._ssrNode("<div data-v-563a0445>", "</div>", [_vm._ssrNode("<h4 class=\"me-1\" data-v-563a0445>" + _vm._ssrEscape("BDT" + _vm._s(item.last_price.toFixed(2))) + "</h4> "), item.discount !== 0 && item.discount !== '' ? _vm._ssrNode("<h4 class=\"disabled\" data-v-563a0445>", "</h4>", [_c('strike', [_vm._v("$" + _vm._s(item.price))]), _vm._ssrNode("<span data-v-563a0445>" + _vm._ssrEscape(_vm._s(item.discount) + "%") + "</span>")], 2) : _vm._e()], 2) : item.discount_status == 2 ? _vm._ssrNode("<div data-v-563a0445>", "</div>", [_vm._ssrNode("<h4 class=\"me-1\" data-v-563a0445>" + _vm._ssrEscape("BDT" + _vm._s(item.last_price.toFixed(2))) + "</h4> "), item.discount !== 0 && item.discount !== '' ? _vm._ssrNode("<h4 class=\"disabled\" data-v-563a0445>", "</h4>", [_c('strike', [_vm._v("$" + _vm._s(item.price))]), _vm._ssrNode("<span data-v-563a0445>" + _vm._ssrEscape("$" + _vm._s(item.discount)) + "</span>")], 2) : _vm._e()], 2) : _vm._ssrNode("<div data-v-563a0445><h4 class=\"me-1\" data-v-563a0445>" + _vm._ssrEscape("BDT" + _vm._s(item.last_price.toFixed(2))) + "</h4></div>"), _vm._ssrNode(" " + (item.stock_qty >= 1 ? "<button type=\"button\" class=\"btn_cart\" style=\"display: block;visibility: unset;\" data-v-563a0445>Add to cart</button>" : "<button type=\"button\" disabled=\"disabled\" class=\"btn_sold\" style=\"display: block;visibility: unset;\" data-v-563a0445>Sold Out</button>"))], 2)], 2)]) : _vm._e()]);
  })], 2)])], 2)])], 2)])]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/CategoryProductFilter.vue?vue&type=template&id=563a0445&scoped=true
...
/* harmony default export */ var CategoryProductFiltervue_type_script_lang_js = ({
  //  props: ['cart'],
  props: ['category_slug'],
  // props: ['product'],
  data() {
...
// CONCATENATED MODULE: ./components/CategoryProductFilter.vue?vue&type=script&lang=js
 /* harmony default export */ var components_CategoryProductFiltervue_type_script_lang_js = (CategoryProductFiltervue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);
...
var component = Object(componentNormalizer["a" /* default */])(
  components_CategoryProductFiltervue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/ProductListFilterList.vue?vue&type=template&id=7fcbf6c6
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-12\">", "</div>", [_vm._ssrNode("<div class=\"product_section\">", "</div>", [_vm._ssrNode("<div class=\"row px-2\">", "</div>", [_vm._ssrNode("<div class=\"col-md-4 desktop_view\"><div class=\"left_side_product\"><div class=\"category_list\"><h6>Category</h6> <ul><li><a href=\"#\">Computing </a></li> <li><a href=\"#\">Electronics </a></li> <li><a href=\"#\">Phone &amp; tablates </a></li> <li><a href=\"#\">Fashion </a></li> <li><a href=\"#\">Home &amp; office </a></li> <li><a href=\"#\">Grocery </a></li> <li><a href=\"#\">Health &amp; beauty </a></li> <li><a href=\"#\">Baby Product </a></li></ul></div> <div class=\"delivery_list\"><h6>Express delivery</h6> <ul><li><input type=\"checkbox\"><label for>DHL </label></li></ul></div> <div class=\"delivery_list\"><h6>Shipped from </h6> <ul><li><input type=\"checkbox\"><label for>From Bangladesh </label></li> <li><input type=\"checkbox\"><label for>From Bangladesh </label></li></ul></div> <div class=\"brands_list\"><h6>Brand</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li></ul></div> <div class=\"price_range\"><div class=\"sidebr_title\"><h6>Price Range </h6> <button type=\"button\" class=\"btn_apply\">Apply</button></div> <div class=\"row\"><div class=\"col-md-12\"><div id=\"slider-range\" name=\"rangeInput\" class=\"price-filter-range\"></div> <div class=\"d-flex\" style=\"margin:10px auto\"><input type=\"number\" min=\"0\" max=\"9900\" oninput=\"validity.valid||(value='0');\" id=\"min_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px;\"> <input type=\"number\" min=\"0\" max=\"10000\" oninput=\"validity.valid||(value='10000');\" id=\"max_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px\"></div></div></div></div> <div class=\"brands_list\"><h6>size</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>XS</label></li> <li><input type=\"checkbox\"><label for>S</label></li> <li><input type=\"checkbox\"><label for>L</label></li> <li><input type=\"checkbox\"><label for>M </label></li> <li><input type=\"checkbox\"><label for>XL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>0-2 Years</label></li> <li><input type=\"checkbox\"><label for>2-3 Years</label></li> <li><input type=\"checkbox\"><label for>3-5 Years</label></li> <li><input type=\"checkbox\"><label for>5-7 Years</label></li> <li><input type=\"checkbox\"><label for>7-10 Years</label></li></ul></div> <div class=\"brands_list\"><h6>Gender</h6> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Boys</label></li> <li><input type=\"checkbox\"><label for>Girls</label></li> <li><input type=\"checkbox\"><label for>Man</label></li> <li><input type=\"checkbox\"><label for>Woman</label></li> <li><input type=\"checkbox\"><label for>Male</label></li> <li><input type=\"checkbox\"><label for>Female</label></li> <li><input type=\"checkbox\"><label for>Teen</label></li></ul></div></div></div> "), _vm._ssrNode("<div class=\"col-md-8\">", "</div>", [_vm._ssrNode("<div class=\"product_list\">", "</div>", [_vm._ssrNode("<div class=\"title_product\"><div><h6>Officail Store Deals</h6></div> <div><label for>Short By:</label> <select name id><option value>Popularity</option> <option value>New arrival</option> <option value>Low to High</option> <option value>high to low</option></select></div></div> "), _vm._ssrNode("<div class=\"grid_list\">", "</div>", [_vm._ssrNode("<div><p>5,000 product found</p></div> "), _vm._ssrNode("<div class=\"d-flex\">", "</div>", [_vm._ssrNode("<a type=\"button\" class=\"filter_btn mobile_view\"><i class=\"fa-solid fa-sliders\"></i></a> "), _c('Nuxt-link', {
    ...
    staticClass: "fa-solid fa-grip"
  })])], 2), _vm._ssrNode(" <div class=\"filter_modal\"><div class=\"row px-4\"><div class=\"col-6\"></div> <div class=\"col-6 text-end\"><i class=\"fa-solid fa-x filter_close\" style=\"cursor: pointer;\"></i></div></div> <div class=\"modal_fdiv\"><div class=\"row\"><div class=\"col-md-12\"><div class=\"left_side_product\"><div class=\"category_list\"><h6>Category</h6> <ul><li><a href=\"#\">Computing </a></li> <li><a href=\"#\">Electronics </a></li> <li><a href=\"#\">Phone &amp; tablates </a></li> <li><a href=\"#\">Fashion </a></li> <li><a href=\"#\">Home &amp; office </a></li> <li><a href=\"#\">Grocery </a></li> <li><a href=\"#\">Health &amp; beauty </a></li> <li><a href=\"#\">Baby Product </a></li></ul></div> <div class=\"delivery_list\"><h6>Express delivery</h6> <ul><li><input type=\"checkbox\"><label for>DHL </label></li></ul></div> <div class=\"delivery_list\"><h6>Shipped from </h6> <ul><li><input type=\"checkbox\"><label for>From Bangladesh </label></li> <li><input type=\"checkbox\"><label for>From Bangladesh </label></li></ul></div> <div class=\"brands_list\"><h6>Brand</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li> <li><input type=\"checkbox\"><label for>Addidas </label></li> <li><input type=\"checkbox\"><label for>AGM </label></li> <li><input type=\"checkbox\"><label for>Apple </label></li> <li><input type=\"checkbox\"><label for>Walton </label></li></ul></div> <div class=\"price_range\"><div class=\"sidebr_title\"><h6>Price Range </h6> <button type=\"button\" class=\"btn_apply\">Apply</button></div> <div class=\"row\"><div class=\"col-md-12\"><div id=\"slider-range\" name=\"rangeInput\" class=\"price-filter-range\"></div> <div class=\"d-flex\" style=\"margin:10px auto\"><input type=\"number\" min=\"0\" max=\"9900\" oninput=\"validity.valid||(value='0');\" id=\"min_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px;\"> <input type=\"number\" min=\"0\" max=\"10000\" oninput=\"validity.valid||(value='10000');\" id=\"max_price\" class=\"price-range-field\" style=\"width: 45%;margin: 0px 3px\"></div></div></div></div> <div class=\"brands_list\"><h6>size</h6> <div class=\"search_side\"><i class=\"fa-solid fa-magnifying-glass\"></i> <input type=\"text\" placeholder=\"Search\" class=\"form-control\"></div> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>XS</label></li> <li><input type=\"checkbox\"><label for>S</label></li> <li><input type=\"checkbox\"><label for>L</label></li> <li><input type=\"checkbox\"><label for>M </label></li> <li><input type=\"checkbox\"><label for>XL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>XXL </label></li> <li><input type=\"checkbox\"><label for>0-2 Years</label></li> <li><input type=\"checkbox\"><label for>2-3 Years</label></li> <li><input type=\"checkbox\"><label for>3-5 Years</label></li> <li><input type=\"checkbox\"><label for>5-7 Years</label></li> <li><input type=\"checkbox\"><label for>7-10 Years</label></li></ul></div> <div class=\"brands_list\"><h6>Gender</h6> <ul class=\"brand_scroll\"><li><input type=\"checkbox\"><label for>Boys</label></li> <li><input type=\"checkbox\"><label for>Girls</label></li> <li><input type=\"checkbox\"><label for>Man</label></li> <li><input type=\"checkbox\"><label for>Woman</label></li> <li><input type=\"checkbox\"><label for>Male</label></li> <li><input type=\"checkbox\"><label for>Female</label></li> <li><input type=\"checkbox\"><label for>Teen</label></li></ul></div></div></div></div></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-12\">", "</div>", [_c('Nuxt-link', {
    attrs: {
      "to": "/product-details"
    }
  }, [_c('div', {
  ...
  }, [_c('strong', [_vm._v("Official store ")]), _vm._v(" "), _c('h5', [_vm._v("Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus tempora eos exercitationem molestias fugit, optio autem at quo perspiciatis!")]), _vm._v(" "), _c('div', {
    ...
    staticClass: "col pad_ding"
  }, [_c('h4', [_vm._v("Tk 6,500")]), _vm._v(" "), _c('h4', {
    staticClass: "disabled"
  }, [_c('strike', [_vm._v("Tk 6,500")]), _c('span', [_vm._v("-45%")])], 1), _vm._v(" "), _c('button', {
  ...
  }, [_vm._v("Sold Out")])])])])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-12\">", "</div>", [_c('Nuxt-link', {
    attrs: {
      "to": "/product-details"
    }
  }, [_c('div', {
  ...
  }, [_vm._v("Add to cart")])])])])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-12\">", "</div>", [_c('Nuxt-link', {
    attrs: {
      "to": "/product-details"
    }
  }, [_c('div', {
    ...
    staticClass: "col pad_ding"
  }, [_c('strong', [_vm._v("Official store ")]), _vm._v(" "), _c('h5', [_vm._v("Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus tempora eos exercitationem molestias fugit, optio autem at quo perspiciatis!")]), _vm._v(" "), _c('p', [_c('i', {
    staticClass: "fa-brands fa-dhl"
  })])]), _vm._v(" "), _c('div', {
    staticClass: "col pad_ding"
  }, [_c('h4', [_vm._v("Tk 6,500")]), _vm._v(" "), _c('h4', {
  ...
  }, [_vm._v("Sold Out")])])])])], 1)], 2), _vm._ssrNode(" <div class=\"row\"><div class=\"col-12\"><div class=\"pagination\"><ul><li><a href=\"#\"> prv </a></li> <li><a href=\"#\" class=\"active\"> 1 </a></li> <li><a href=\"#\"> 2 </a></li> <li><a href=\"#\"> 3 </a></li> <li><a href=\"#\"> next </a></li></ul></div></div></div>")], 2)])], 2)])])])]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/ProductListFilterList.vue?vue&type=template&id=7fcbf6c6

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/ProductListFilterList.vue
...
/* harmony default export */ var ProductListFilterList = __webpack_exports__["default"] = (component.exports);
