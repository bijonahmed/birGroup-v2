exports.ids = [88,17,19,21,25,28,29,33];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/refund.vue?vue&type=template&id=05b0f644
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('LogoAndPayment'), _vm._ssrNode(" "), _c('NavbarSecond'), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"main_content\">", "</section>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"container mt-5\">", "</div>", [_vm._ssrNode("<h1 class=\"mb-4\">", "</h1>", [_c('center', [_vm._v("Refund Policy")])], 1), _vm._ssrNode(" <div class=\"card mb-4\"><div class=\"card-body\"><h3 class=\"card-title\">Eligibility for Returns</h3> <p class=\"card-text\">To be eligible for a return, your item must meet the following criteria:</p> <ul><li>It must be in unused and in the same condition that you received it.</li> <li>It must be in the original packaging.</li> <li>Returns must be requested within [number of days] days of the purchase date.</li></ul></div></div> <div class=\"card mb-4\"><div class=\"card-body\"><h3 class=\"card-title\">How to Request a Return</h3> <p class=\"card-text\">If your item meets the eligibility criteria, please follow these steps to request a return:</p> <ol><li>Contact our customer support team at [customer support email or phone number] to initiate the return process.</li> <li>[Add any other specific instructions or forms required for returns]</li></ol></div></div> <div class=\"card mb-4\"><div class=\"card-body\"><h3 class=\"card-title\">Refund Process</h3> <p class=\"card-text\">Once we receive your returned item and inspect it, we will send you an email to notify you of the approval or rejection of your refund. If approved, your refund will be processed, and a credit will automatically be applied to your original payment method within [number of days] days.</p></div></div> <div class=\"card mb-4\"><div class=\"card-body\"><h3 class=\"card-title\">Return Shipping</h3> <p class=\"card-text\">The cost of return shipping is the responsibility of the customer, unless the return is due to an error on our part. If the return is due to our error, we will cover the cost of return shipping.</p></div></div> <div class=\"card mb-4\"><div class=\"card-body\"><h3 class=\"card-title\">Exceptions</h3> <p class=\"card-text\">There are certain situations where only partial refunds may be granted:</p> <ul><li>Items that are returned more than [number of days] days after delivery.</li> <li>Any item that is not in its original condition, is damaged, or is missing parts for reasons not due to our error.</li></ul></div></div> <div class=\"card mb-4\"><div class=\"card-body\"><h3 class=\"card-title\">Contact Us</h3> <p class=\"card-text\">If you have any questions about our refund policy, please contact us at [customer support email or phone number].</p></div></div>")], 2)])])]), _vm._ssrNode(" <div class=\"back_top\"><a href=\"#top\"><i class=\"fa-solid fa-angle-up\"></i></a></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/refund.vue?vue&type=template&id=05b0f644
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/refund.vue?vue&type=script&lang=js


/* harmony default export */ var refundvue_type_script_lang_js = ({
  comments: {
...
// CONCATENATED MODULE: ./pages/refund.vue?vue&type=script&lang=js
 /* harmony default export */ var pages_refundvue_type_script_lang_js = (refundvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/refund.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_refundvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var refund = __webpack_exports__["default"] = (component.exports);
