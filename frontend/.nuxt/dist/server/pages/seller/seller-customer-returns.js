exports.ids = [103,17,18,19,21,25,28,29,33,105];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/seller/seller-customer-returns.vue?vue&type=template&id=77c0c8c0
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('LogoAndPayment'), _vm._ssrNode(" "), _c('NavbarSecond'), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"main_content\">", "</section>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-md-4\">", "</div>", [_c('SellerLeftsidebar')], 1), _vm._ssrNode(" <div class=\"col-md-8\"><ul id=\"pills-tab\" role=\"tablist\" class=\"tab_btns nav-pills mb-3 mt-3\"><li role=\"presentation\" class=\"nav-item\"><button id=\"pills-here-tab\" data-bs-toggle=\"pill\" data-bs-target=\"#seller_account\" type=\"button\" role=\"tab\" aria-controls=\"pills-home\" aria-selected=\"true\" class=\"nav-link active\">In Progress</button></li> <li role=\"presentation\" class=\"nav-item\"><button id=\"pills-profile-tab\" data-bs-toggle=\"pill\" data-bs-target=\"#pills-business\" type=\"button\" role=\"tab\" aria-controls=\"pills-profile\" aria-selected=\"false\" class=\"nav-link\">Close </button></li></ul> <div class=\"returns_alert\"><div class=\"alert alert-primary\"><i class=\"fa-solid fa-exclamation\"></i>Ecommerce Seller Center is unable to generate a report for returns that happened prior to 20 June 2022.</div></div> <div class=\"days_filter\"><div class=\"row\"><div class=\"col-12\"><div class=\"only_days\"><button type=\"button\">Today</button> <button type=\"button\">Yesterday</button> <button type=\"button\">7 Days</button> <button type=\"button\">30 Days</button> <div class=\"d-flex\"><input type=\"text\" onfocus=\"(this.type='date')\" placeholder=\"Start Date\"> <input type=\"text\" onfocus=\"(this.type='date')\" placeholder=\"End Date\"> <button type=\"button\">OK</button></div></div> <div class=\"return_filter\"><form action><div style=\"width: 100%;\"><select name id><option value selected=\"selected\" disabled=\"disabled\">Return status </option> <option value>Return Initiated to seller</option> <option value>Buyer initiated returns </option> <option value>Pickup by courier</option> <option value>Pending Ecommerce Inspection</option></select></div> <div class=\"ms-2 d-flex align-items-center\" style=\"width: 100%;\"><input type=\"text\" placeholder=\"Order Id\"> <button type=\"button\"><i class=\"fa-solid fa-magnifying-glass\"></i> search</button></div></form></div></div></div> <div class=\"row\"><div class=\"col-12\"><div class=\"d-flex\"><button type=\"button\" class=\"tb2xl_btn btn_download\">Export</button> <button type=\"button\" class=\"btn_download\">View History</button></div></div></div></div> <div id=\"pills-tabContent\" class=\"tab-content\"><div id=\"seller_account\" role=\"tabpanel\" aria-labelledby=\"pills-here-tab\" class=\"tab-pane fade show active\"><div class=\"key_summary\"><div class=\"row\"><div class=\"col-lg-4 col-md-4 col-sm-6 col-6\"><div class=\"count_box\"><h5>Order Under Review <i class=\"fa-solid fa-circle-exclamation\"></i></h5> <h4>0</h4></div></div> <div class=\"col-lg-4 col-md-4 col-sm-6 col-6\"><div class=\"count_box\"><h5>Ammount Under Review <i class=\"fa-solid fa-circle-exclamation\"></i></h5> <h4>0</h4></div></div></div></div> <div class=\"main_profile\"><div class=\"user_details\"><table id=\"MyTableID\" class=\"table\"><thead><tr><th>Product</th> <th>Ammount</th> <th>Status</th> <th>Reason</th> <th>Comment</th></tr></thead> <tbody><tr><td>#99343</td> <td>230 TK</td> <td class=\"text-success\">Success</td> <td> Defective</td> <td>Please change my product </td></tr></tbody></table> <div class=\"row\"><div class=\"col-12\"><div class=\"pagination\"><ul><li><a href=\"#\"> prv </a></li> <li><a href=\"#\" class=\"active\"> 1 </a></li> <li><a href=\"#\"> 2 </a></li> <li><a href=\"#\"> 3 </a></li> <li><a href=\"#\"> next </a></li></ul></div></div></div></div></div></div> <div id=\"pills-business\" role=\"tabpanel\" aria-labelledby=\"pills-profile-tab\" class=\"tab-pane fade\"><div class=\"key_summary\"><div class=\"row\"><div class=\"col-lg-4 col-md-4 col-sm-6 col-6\"><div class=\"count_box\"><h5>Product Return to seller <i class=\"fa-solid fa-circle-exclamation\"></i></h5> <h4>0</h4></div></div> <div class=\"col-lg-4 col-md-4 col-sm-6 col-6\"><div class=\"count_box\"><h5>Product Returned to Warehouse <i class=\"fa-solid fa-circle-exclamation\"></i></h5> <h4>0</h4></div></div> <div class=\"col-lg-4 col-md-4 col-sm-6 col-6\"><div class=\"count_box\"><h5>Lost &amp; Damaged by Courier <i class=\"fa-solid fa-circle-exclamation\"></i></h5> <h4>0</h4></div></div></div></div> <div class=\"main_profile\"><div class=\"user_details\"><div class=\"d-flex align-items-center justify-content-between mb-3\"><table id=\"MyTableID\" class=\"table\"><thead><tr><th>Product</th> <th>Ammount</th> <th>Status</th> <th>Reason</th> <th>Comment</th></tr></thead> <tbody><tr><td>#99343</td> <td>230 TK</td> <td class=\"text-warning\">Process</td> <td> Defective</td> <td>Please change my product </td></tr></tbody></table></div></div></div></div></div></div>")], 2)])]), _vm._ssrNode(" <div class=\"back_top\"><a href=\"#top\"><i class=\"fa-solid fa-angle-up\"></i></a></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/seller/seller-customer-returns.vue?vue&type=template&id=77c0c8c0
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/seller/seller-customer-returns.vue?vue&type=script&lang=js
...
/* harmony default export */ var seller_customer_returnsvue_type_script_lang_js = ({
  middleware: 'IsSeller',
  components: {
...
// CONCATENATED MODULE: ./pages/seller/seller-customer-returns.vue?vue&type=script&lang=js
 /* harmony default export */ var seller_seller_customer_returnsvue_type_script_lang_js = (seller_customer_returnsvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/seller/seller-customer-returns.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  seller_seller_customer_returnsvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var seller_customer_returns = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=seller-customer-returns.js.map