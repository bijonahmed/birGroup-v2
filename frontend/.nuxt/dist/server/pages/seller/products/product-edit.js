exports.ids = [98,17,18,19,21,25,28,29,33,105];
exports.modules = {
...
var render = function render() {
  ...
  }, [_vm._v("No")])])])], 2), _vm._ssrNode(" <hr> "), _vm._ssrNode("<div class=\"row mb-3 required\">", "</div>", [_vm._ssrNode("<label for=\"input-meta-title-1\" class=\"col-sm-4 col-form-label\">Product\n                                                                            Status</label> "), _vm._ssrNode("<div class=\"col-sm-4\">", "</div>", [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }) + "</ul>" : "<div></div>") + " <hr>\n                                                                                Selected Categorys:\n\n                                                                                 <ul>" + _vm._ssrList(_vm.showProCategories, function (item, index) {
    return "<li><span>" + _vm._s(item) + "</span> <button type=\"button\"><i class=\"fa-solid fa-circle-minus\"></i></button></li>";
  ...
  }) + "</div>" : "<!---->") + "</div></div></div> <div class=\"row mb-3\"><label for=\"input-meta-description-1\" class=\"col-sm-2 col-form-label\">Download\n                                                                            Link</label> <div class=\"col-sm-10\"><input type=\"text\" name=\"keyword\" value placeholder=\"Download\" class=\"form-control\"></div></div>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div id=\"image\" role=\"tabpanel\" class=\"tab-pane fade\">", "</div>", [_vm._ssrNode("<div bis_skin_checked=\"1\" class=\"alert alert-info\"><i class=\"fas fa-info-circle\"></i> Must Upload Products\n                                                                Images 300x300px</div> <div class=\"row mb-3\"><label for=\"input-meta-description-1\" class=\"col-sm-2 col-form-label\">Thumbnail\n                                                                    Image</label> <div class=\"col-sm-10\"><input type=\"file\" value accept=\"image/png,image/jpeg\" class=\"form-control\"> <img" + _vm._ssrAttr("src", _vm.productImg) + " alt=\"N/A\" class=\"img-fluid max-width-100 img-thumbnail\"> " + (_vm.previewUrl ? "<img" + _vm._ssrAttr("src", _vm.previewUrl) + " alt=\"Preview\" class=\"img-fluids\">" : "<!---->") + "</div></div> "), _vm._ssrNode("<div class=\"row mb-3\">", "</div>", [_vm._ssrNode("<label for=\"input-meta-description-1\" class=\"col-sm-2 col-form-label\">Additional\n                                                                    Image</label> "), _vm._ssrNode("<div class=\"col-sm-10\">", "</div>", [_vm._ssrNode("<input type=\"file\" multiple=\"multiple\" accept=\"image/png,image/jpeg\" class=\"form-control\"> "), _vm._ssrNode("<div class=\"row\">", "</div>", _vm._l(_vm.productAddImgs, function (data, index) {
    return _vm._ssrNode("<div class=\"col-md-2\">", "</div>", [_vm._ssrNode("<img" + _vm._ssrAttr("src", data.images) + " alt=\"N/A\" class=\"img-fluid max-width-100 img-thumbnail\"> "), _c('center', [_c('button', {
      attrs: {
        "type": "button"
      },
      on: {
  ...
  }), 0), _vm._ssrNode(" <div class=\"row mt-3\">" + _vm._ssrList(_vm.images, function (image, index) {
  ...
  }) + "</div>")], 2)], 2), _vm._ssrNode(" <button type=\"submit\" class=\"btn btn-success px-5 w-100\"><i class=\"bx bx-check-circle mr-1\"></i> Save &amp;\n                                                                Next</button>")], 2)], 2)], 2)])])])])])])])])], 2)])]), _vm._ssrNode(" <div class=\"back_top\"><a href=\"#top\"><i class=\"fa-solid fa-angle-up\"></i></a></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/seller/products/product-edit.vue?vue&type=template&id=fc24bc00

// EXTERNAL MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/seller/products/product-edit.vue?vue&type=script&lang=js
var product_editvue_type_script_lang_js = __webpack_require__(93);

// CONCATENATED MODULE: ./pages/seller/products/product-edit.vue?vue&type=script&lang=js
 /* harmony default export */ var products_product_editvue_type_script_lang_js = (product_editvue_type_script_lang_js["a" /* default */]); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/seller/products/product-edit.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  products_product_editvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
"use strict";
/* WEBPACK VAR INJECTION */(function(URL) {/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34);
...
/* harmony import */ var _components_Common_MobileSearchProduct_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(67);
/* harmony import */ var _pages_seller_seller_leftsidebar_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(73);
/* harmony import */ var _components_NavbarSecond_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(60);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  middleware: 'auth',
  components: {
    NavbarSecond: _components_NavbarSecond_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
  ...
  methods: {
    ...
    productDetails() {
      ...
      this.$axios.get(`/product/productrow/${product_id}`).then(response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".pro_description").html(response.data.product.description);
