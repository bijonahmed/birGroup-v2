            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="dashCount">
                        ...
                        <div class="dashCbox">
                            <img src="/images/dashboard/icons/shopping-bag-100.png" class="img-fluid" loading="lazy" alt="products">
                            <h2 class="fw-bold">1000</h2>
                            <p>Total Selling </p>
                        </div>
                        <div class="dashCbox">
                        ...
                        <div class="dashCbox">
                            <img src="/images/dashboardicons/defective-product-100.png" class="img-fluid" loading="lazy" alt="products">
                            <h2 class="fw-bold">1000</h2>
                            <p>Total Returns </p>
                        </div>
                        <div class="dashCbox">
                        ...
                        <div class="dashCbox dbLink">
                            ...
                            <p><nuxt-link to="/seller/seller-comission-history">Comission History</nuxt-link></p>
                        </div>
                        <div class="dashCbox dbLink">
                            <img src="/images/dashboardicons/list-100.png" class="img-fluid" loading="lazy" alt="products">
                            <p><nuxt-link to="/seller/seller-payment-history">Payment History</nuxt-link></p>
                        </div>
                    </div>
                </div>
            </div>
