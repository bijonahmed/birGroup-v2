                        ...
                        <div class="col-md-7">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-2">
                                        <label for="input-description-1" class="">Sellers</label>
                                        <client-only placeholder="loading...">
                                              <select class="form-select form-select-solid status" v-model="insertdata.seller_id">
...
export default {
    ...
    methods: {
        ...
        saveData() {
            ...
            formData.append('seller_id', this.insertdata.seller_id);
            //new
        ...
        async productDetails() {
            ...
            this.$axios.get(`/product/productrow/${product_id}`).then(response => {
                ...
                this.insertdata.seller_id = response.data.product.seller_id;
