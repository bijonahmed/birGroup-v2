        ...
        <div class="page-wrapper">
                                    ...
                                    <table class="table table-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr v-for="(blog, index) in blogs.data" :key="blog.id">
                                                ...
                                                <td> 
                                                    <span v-if="blog.status ==1" class="badge bg-success">Approve</span> 
                                                    <span v-if="blog.status ==2" class="badge bg-warning">Pending</span> 
                                                    <span v-if="blog.status ==3" class="badge bg-danger">Reject</span> 
                                                </td>
                                                <td>
            ...
            <ul class="pagination">
                <li class="page-item" :class="{ disabled: !blogs.prev_page_url }">
                    <a class="page-link" href="#" @click.prevent="fetchBlogs(blogs.current_page - 1)">Previous</a>
                </li>
                <li class="page-item" :class="{ disabled: !blogs.next_page_url }">
                    <a class="page-link" href="#" @click.prevent="fetchBlogs(blogs.current_page + 1)">Next</a>
                </li>
            </ul>
        </nav>
                                    </table>
...
export default {
    ...
    methods: {
        fetchBlogs(page = 1) {
            this.$axios.get(`/blog/bloglist?page=${page}`)
                .then(response => {
